...
upsetplot aggregate row counts per category combination, and writes two
complementary PNGs per run that partition all intersections at n
(--min-subset-size, n > 1): a "_below<n>" plot (subsets smaller than n) and a
"_min<n>" plot (subsets of at least n).
